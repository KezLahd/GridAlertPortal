...
export function MobileDropdownSelect({
  value,
  options,
  onChange,
  placeholder,
  ...
  return (
    <Popover open={open} onOpenChange={handleOpenChange}>
      <PopoverTrigger asChild>
        ...
        >
          <span className="truncate !text-white">{display}</span>
            ...
            >
                  <div
                    className={cn(
                      ...
                      value === opt.value
                        ? "border-white bg-white text-black md:border-black md:bg-black md:text-white"
