  ...
  return (
    <Input
      ...
      classNames={{
        ...
        label: "text-slate-700 data-[inside=true]:text-slate-500 group-data-[filled=true]:text-slate-700 group-data-[focus-within=true]:text-slate-700 group-data-[invalid=true]:!text-red-500 data-[invalid=true]:!text-red-500",
      }}
    />
  )
})
