  ...
  return (
    <div className="mx-auto w-full max-w-7xl space-y-6 p-4 sm:p-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="md:col-span-2 lg:col-span-1 rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-6">
        ...
        <div className="md:col-span-2 rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-6">
          <div className="space-y-2 pb-3">
            <Skeleton className="h-6 w-32 rounded" />
